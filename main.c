...
* File Name:   main.c
*
* Description: This is the source code for the PSOC Control C1 MCU: MATH CORDIC example
...
#define ANGLE_TO_CORDIC_Z(ANGLE) ((Cy_MATH_Q0_23_t)((ANGLE) * ((float)TWO_POWER_TWENTY_THREE / PI)))
...
Cy_MATH_Q1_22_t cordic_result_q1_22;
...
void float_to_string(char* string_buffer, uint8_t buf_size, float number)
{
    ...
    int decimal_part = (int)((number - (float)integral_part) * 1000.0f);
    if(is_negative)
    {
...
void MATH0_0_IRQHandler(void)
{
    ...
    Cy_MATH_ClearEvent(CY_MATH_EVENT_CORDIC_END_OF_CALC);

    /* Read the calculated result */
    cordic_result_q1_22 = Cy_MATH_CORDIC_GetSinhResult();
...
int main(void)
{
    ...
    Cy_MATH_Q0_23_t cordic_result_q0_23;

    /* Variable used to store the angle input */
    Cy_MATH_Q0_23_t angle;
    ...
    printf("\x1b[2J\x1b[;H");
    printf("===============================================================\r\n");
    printf("PSOC Control C1 MCU: MATH CORDIC example\r\n");
    printf("===============================================================\r\n\n");
    ...
    cordic_result_q0_23 = Cy_MATH_CORDIC_Cos(angle);
